AFRAME.registerComponent('create-can-component', {
    schema: {},
    init : function() {
    ...
    createCow : function() {
        ...
        cowElem.setAttribute('gltf-model', {gltf:'/assets/models/crushedcan/scene.gltf'});
        cowElem.setAttribute('material', {src:'/assets/textures/cantextures/blinn1_baseColor.png'});
